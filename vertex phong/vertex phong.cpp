...
d3ddevice->CreateVertexShader( dwDecl, (DWORD*)pCode->GetBufferPointer(), &basic_shader, /*D3DUSAGE_SOFTWAREPROCESSING*/0 );
pCode->Release();
DWORD dwDeclp[] =
{
    D3DVSD_STREAM(0),
...
LPD3DXBUFFER pCode2;
D3DXAssembleShaderFromFile("phong shader.txt"/*phong,strlen(phong)*/,0,NULL,&pCode2,NULL);
d3ddevice->CreateVertexShader( dwDeclp, (DWORD*)pCode2->GetBufferPointer(), &phong_shader, /*D3DUSAGE_SOFTWAREPROCESSING*/0 );
pCode2->Release();
