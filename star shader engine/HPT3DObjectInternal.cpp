...
void HPT3DObjectInternal::RenderPoints()
{
	float dist;
	dist = 	world(3,0)*world(3,0) + world(3,1)*world(3,1) + world(3,2)*world(3,2);
...
//		gengine->RenderSphereL(full,close_texture,24,color,noise_position);
	...
	{*/
		...
		D3DXMatrixMultiply(&full,&rot_worldy,&rot_worldz);
		D3DXMatrixMultiply(&full,&full,&world);
		gengine->RenderSpherePoints(full,close_texture,24,color,noise_position);
...
/*		gengine->GetD3DDevice()->SetRenderState( D3DRS_ZENABLE, TRUE );
		...
		D3DXMatrixMultiply(&full,&rot_worldy,&rot_worldz);
		D3DXMatrixMultiply(&full,&full,&world);
		gengine->RenderSpherePoints(world,close_texture,24,color,noise_position);
		*/
...
void HPT3DObjectInternal::RenderPoints2()
{
	float dist;
	dist = 	world(3,0)*world(3,0) + world(3,1)*world(3,1) + world(3,2)*world(3,2);
		...
		D3DXMatrixMultiply(&full,&rot_worldy,&rot_worldz);
		D3DXMatrixMultiply(&full,&full,&world);
		gengine->RenderSpherePoints2(full,close_texture,24,color,noise_position);

}

void HPT3DObjectInternal::Render2()
{
	float dist;
	dist = 	world(3,0)*world(3,0) + world(3,1)*world(3,1) + world(3,2)*world(3,2);
		...
		D3DXMatrixMultiply(&full,&rot_worldy,&rot_worldz);
		D3DXMatrixMultiply(&full,&full,&world);
		gengine->RenderSphere2(full,close_texture,24,D3DXVECTOR4(temperature,temperature,temperature,temperature),noise_position);
...
void HPT3DObjectInternal::SetTemperature(int arg)
{
	temperature = arg;
}
