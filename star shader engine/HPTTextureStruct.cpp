...
//	z_stream zlib_stream;
	...
	{
		D3DXCreateTexture(gengine->GetD3DDevice(),width,height,0,D3DUSAGE_DYNAMIC,D3DFMT_A8R8G8B8,D3DPOOL_DEFAULT,&texture);
		//gengine->GetD3DDevice()->CreateTexture(width,height,0,0,D3DFMT_A8R8G8B8,D3DPOOL_MANAGED,&texture,NULL);
