...
public:
	...
	virtual void SetTemperature(int arg) = 0;
	virtual void SetBrightness(float r,float g,float b) = 0;
...
//	virtual HPTGraphicsEngine& operator<<(HPTFont1* arg) = 0;
	...
	virtual void ResetStarTextureForFull() = 0;
};*/
