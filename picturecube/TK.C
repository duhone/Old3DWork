...
static void (CALLBACK *ExposeFunc)(int, int)              = NULL;
static void (CALLBACK *ReshapeFunc)(GLsizei, GLsizei)     = NULL;
static void (CALLBACK *DisplayFunc)(void)                 = NULL;
static GLenum (CALLBACK *KeyDownFunc)(int, GLenum)        = NULL;
static GLenum (CALLBACK *MouseDownFunc)(int, int, GLenum) = NULL;
static GLenum (CALLBACK *MouseUpFunc)(int, int, GLenum)   = NULL;
...
void tkExposeFunc(void (CALLBACK *Func)(int, int))
{
    ExposeFunc = Func;
}

void tkReshapeFunc(void (CALLBACK *Func)(GLsizei, GLsizei))
{
    ReshapeFunc = Func;
}

void tkDisplayFunc(void (CALLBACK *Func)(void))
{
    DisplayFunc = Func;
}

void tkKeyDownFunc(GLenum (CALLBACK *Func)(int, GLenum))
{
    KeyDownFunc = Func;
}

void tkMouseDownFunc(GLenum (CALLBACK *Func)(int, int, GLenum))
{
    MouseDownFunc = Func;
}

void tkMouseUpFunc(GLenum (CALLBACK *Func)(int, int, GLenum))
{
    MouseUpFunc = Func;
}

void tkMouseMoveFunc(GLenum (CALLBACK *Func)(int, int, GLenum))
{
    MouseMoveFunc = Func;
}

void tkIdleFunc(void (CALLBACK *Func)(void))
{
    IdleFunc = Func;
}
...
// Cleanup the palette.
    ...
    // If static system color usage is set, restore the system colors.
        ...
        {
        	hStock = (HPALETTE)GetStockObject( DEFAULT_PALETTE );
            if ( hStock )
